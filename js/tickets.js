...
quantity1.addEventListener("change", updatePricesSpan);
quantity2.addEventListener("change", updatePricesSpan);
...
function updatePricesSpan() {
	...
	if (pass1.options[pass1.selectedIndex].value == 1) {
	...
	if(pass2.options[pass2.selectedIndex].value == 1){
        ...
        individualPrice2.innerHTML = " 3x $" + threeDayPass;
	}
}
